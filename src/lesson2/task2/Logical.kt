 ...
 */
fun queenThreatens(x1: Int, y1: Int, x2: Int, y2: Int): Boolean = ((x1 == x2) || (y1 == y2) || (abs(y1 - y2) == abs(x1 - x2)))
 ...
 */
fun brickPasses(a: Int, b: Int, c: Int, r: Int, s: Int): Boolean = (a <= r || b <= r || c <= r) && (a <= s || b <= s || c <= s)